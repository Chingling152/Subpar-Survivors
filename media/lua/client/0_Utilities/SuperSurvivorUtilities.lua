...
function getFleeSquare(fleeGuy, attackGuy)
    ...
    return fleeGuy:getCell():getGridSquare(fleeGuy:getX() + tempx + ZombRand(-5, 5),
        fleeGuy:getY() + tempy + ZombRand(-5, 5), fleeGuy:getZ());
end
...
function getTowardsSquare(moveguy, x, y, z)
    ...
    return moveguy:getCell():getGridSquare(moveguy:getX() + tempx + ZombRand(-2, 2),
        moveguy:getY() + tempy + ZombRand(-2, 2), moveguy:getZ());
end
...
function getSideSquare(square, supersurvivor)
    ...
    if (nsquare ~= nil) then
        if ((supersurvivor:getWalkToAttempt(nsquare) == 0 and (nsquare:isFree(false)) and
            (nsquare:isBlockedTo(player:getCurrentSquare()) == false)) or (supersurvivor:getWalkToAttempt(nsquare) ~= 0)) and
            (nsquare:isOutside() == false) then
            return nsquare
        end

        nnsquare = GetAdjSquare(nsquare, 'E');
        if (nnsquare ~= nil) and ((supersurvivor:getWalkToAttempt(nnsquare) == 0 and (nnsquare:isFree(false)) and
            (nnsquare:isBlockedTo(player:getCurrentSquare()) == false)) or
            (supersurvivor:getWalkToAttempt(nnsquare) ~= 0)) and (nnsquare:isOutside() == false) then
            return nnsquare
        end
...
if (isModEnabled("Brita_2")) then
    SurvivorRandomSuits["Rare"]["Army"] = {
		...
		"Base.Tshirt_ArmyGreen", "Base.Jacket_CoatArmy","Brita_2.Bag_Plate_Carrier", -- torso
		"Brita_2.Bag_D3M", -- acessories
		"Base.Trousers_ArmyService","Base.Shoes_ArmyBoots" -- legs
	}
    SurvivorRandomSuits["Rare"]["ArmyCamo"] = {
		"Brita_2.Hat_FAST_Opscore", "Brita_2.Hat_Sordin",
		"Base.Tshirt_CamoDesert", "Base.Shirt_CamoDesert","Base.Jacket_ArmyCamoDesert", "Brita_2.Bag_Plate_Carrier",
        "Brita_2.Bag_D3M", 
		"Base.Trousers_CamoDesert","Base.Shoes_ArmyBootsDesert"
	}
    SurvivorRandomSuits["Rare"]["MarinesCamo"] = {
		"Base.Hat_Army", "Brita_2.Hat_Helmet_Headset",
        "Base.Tshirt_CamoGreen", "Base.Shirt_CamoGreen","Base.Jacket_ArmyCamoGreen", 
		"Base.Vest_BulletArmy","Brita_2.Bag_D3M", 
		"Base.Trousers_CamoGreen", "Base.Shoes_ArmyBoots"
	}
else
    SurvivorRandomSuits["Rare"]["Army"] = {
		"Base.Hat_BeretArmy", "Base.Tshirt_ArmyGreen", "Base.Jacket_CoatArmy", 
		"Base.Bag_ALICEpack", 
		"Base.Trousers_ArmyService", "Base.Shoes_ArmyBoots"
	}
    SurvivorRandomSuits["Rare"]["ArmyCamo"] = {
		"Base.Tshirt_CamoDesert", "Base.Shirt_CamoDesert","Base.Jacket_ArmyCamoDesert", 
		"Base.Bag_ALICEpack", 
		"Base.Trousers_CamoDesert", "Base.Shoes_ArmyBootsDesert"
	}
    SurvivorRandomSuits["Rare"]["MarinesCamo"] = {
		"Base.Hat_Army", 
		"Base.Tshirt_CamoGreen", "Base.Shirt_CamoGreen","Base.Jacket_ArmyCamoGreen", 
		"Base.Bag_ALICEpack","Base.Vest_BulletArmy", 
		"Base.Trousers_CamoGreen","Base.Shoes_ArmyBoots"
	}
end
...
if (isModEnabled("TWDRG")) then
    SurvivorRandomSuits["Rare"]["Sheriff1"] = {
		"TWDRG.Hat_Police_Sheriff", "TWDRG.TShirt_Police_Sheriff",
        "TWDRG.Shirt_Police_Sheriff", "TWDRG.Trousers_Police_Sheriff",
        "TWDRG.Jacket_Police_Sheriff", "TWDRG.Vest_BulletPolice_Sheriff",
...
SurvivorRandomSuits["Rare"]["Groom1M"] = {
	"Base.WeddingJacket","Base.Shirt_FormalWhite", 
	"Base.Tie_BowTieFull", "Base.Gloves_WhiteTINT", 
	"Base.Trousers_Suit", "Base.Socks_Long","Shoes_Black"
}
SurvivorRandomSuits["Rare"]["Priest1"] = {
	"Base.Shirt_Priest", 
	"Base.Trousers_Suit", "Base.Socks_Ankle","Base.Shoes_Black"
}
SurvivorRandomSuits["Rare"]["ShopSpiffo1"] = {
	"Base.Tshirt_BusinessSpiffo", "Base.Apron_Spiffos",
	 "Base.TrousersMesh_DenimLight", "Base.Socks_Ankle","Base.Shoes_TrainerTINT"
}
...
SurvivorRandomSuits["Rare"]["Nurse1"] = {
	...
	"Base.Tshirt_Scrubs", 
	"Base.Trousers_Scrubs", "Base.Socks_Ankle", "Base.Shoes_Black"
}
SurvivorRandomSuits["Rare"]["Prepper1"] = {
	"Base.Hat_GasMask", 
	"Base.HoodieUP_GreenTINT", 
...
SurvivorRandomSuits["Normal"]["Athlete1"] = {
	"Base.Tshirt_Sport",
	"Base.Shorts_ShortSport", "Base.Socks_Ankle", "Base.Shoes_TrainerTINT"
}
...
SurvivorRandomSuits["Normal"]["Office1F"] = {
	"Base.Shirt_FormalWhite", 
	"Base.Skirt_Normal", "Base.Socks_Long","Base.Shoes_Black"
}
...
SurvivorRandomSuits["Normal"]["Generic1F"] = {
	"Base.Dress_Normal", "Base.Socks_Ankle", "Base.Shoes_Black"
}
SurvivorRandomSuits["Normal"]["Generic2F"] = {
	"Base.Hat_Beret", 
	"Base.Dress_Knees", "Base.Socks_Long","Base.Shoes_Black"
}
SurvivorRandomSuits["Normal"]["Generic3F"] = {
	"Base.Dress_Long", "Base.Socks_Long", "Base.Shoes_Black"
}
...
SurvivorRandomSuits["Common"]["Generic5F"] = {
	"Base.Hat_Beret", "Base.Tshirt_DefaultTEXTURE", 
	"Base.Skirt_Knees","Base.Socks_Long","Base.Shoes_Black"
}
SurvivorRandomSuits["Common"]["Generic6F"] = {
	"Base.Tshirt_DefaultTEXTURE",
	"Base.Skirt_Long", "Base.Socks_Long","Base.Shoes_Black"
}
SurvivorRandomSuits["Common"]["Generic1M"] = {
	"Base.HoodieDOWN_GreyTINT", "Base.Tshirt_Rock", 
	"Base.TrousersMesh_DenimLight", "Base.Socks_Ankle","Base.Shoes_TrainerTINT"
}
...
SurvivorRandomSuits["Common"]["Basic1"] = {
	...
	"Base.TrousersMesh_DenimLight", "Base.Shoes_Black"
}
...
function getRandomSurvivorSuit(SS)
    ...
    while (string.sub(result, -1) == "F" and not SS.player:isFemale()) or
        (string.sub(result, -1) == "M" and SS.player:isFemale()) do
...
function SpiralSearch:next()
    if (self.ix == self.iy or (self.ix < 0 and self.ix == 0 - self.iy) or (self.ix > 0 and self.ix == 1 - self.iy)) then
        -- change direction
